...
다만 AI Gateway가 항상 검색, Memory, 도구 실행 자체를 담당하는 것은 아니다. 많은 구조에서는 Gateway가 공통 정책, 관측, 인증, 라우팅을 맡고, 실제 RAG/Memory/Tool orchestration은 애플리케이션이나 에이전트 런타임이 담당한다.
